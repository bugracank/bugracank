        ...
        <div className="urunler-inner-container">
          <div className="iframe-container">
            <div className="iframe-inner-container">
              <iframe src="https://panel.360photoboxcloud.com/viewer360/viewer.html?id=397ce652"></iframe>
            </div>
            <div className="iframe-inner-container">
              <iframe src="https://panel.360photoboxcloud.com/viewer360/viewer.html?id=492580ed"></iframe>
            </div>
            <div className="iframe-inner-container">
              <iframe src="https://panel.360photoboxcloud.com/viewer360/viewer.html?id=36299121"></iframe>
            </div>
            <div className="iframe-inner-container">
              <iframe src="https://panel.360photoboxcloud.com/viewer360/viewer.html?id=741dfdde"></iframe>
            </div>
            <div className="iframe-inner-container">
              <iframe src="https://panel.360photoboxcloud.com/viewer360/viewer.html?id=151ed0f1"></iframe>
            </div>
            <div className="iframe-inner-container">
              <iframe src="https://panel.360photoboxcloud.com/viewer360/viewer.html?id=80933b26"></iframe>
            </div>
          </div>
        </div>
      </div>
